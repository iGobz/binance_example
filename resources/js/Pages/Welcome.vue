                            ...
                            >
                                ...
                                >
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0 text-center">
                                        ...
                                        <h2 class="text-center text-xl font-semibold text-black dark:text-white" v-if="canLogin">
                                            {{ $page.props.auth.user ? 'Please proceed to the dashboard' : 'Please proceed with login or registration' }}
                                        </h2>
